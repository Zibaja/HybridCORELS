...
def run(dataset_name, n_seeds, train_proportion):
    ...
    for model_key in ESTIMATORS.keys():
        ...
        min_covs = ESTIMATORS[model_key]["hparams"].get("min_coverage", [None])
        ...
        for min_cov in min_covs:
            ...
            for seed in range(n_seeds):
                ...
                run_one_seed( ### corret it 
                    ...
                    min_cov=min_cov,
                    seed=seed,
                    time_limit=10,  #should be changed later
